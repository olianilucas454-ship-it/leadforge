...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary: 'bg-accent hover:bg-accent-hover text-black font-semibold focus:ring-accent',
      secondary: 'bg-surface border border-border hover:bg-surface-hover text-text-primary focus:ring-border',
      ghost: 'bg-transparent hover:bg-surface-hover text-text-primary focus:ring-surface-hover',
